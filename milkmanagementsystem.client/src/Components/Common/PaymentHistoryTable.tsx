...
const PaymentHistoryTable: React.FC<Props> = ({ isAdmin, currentEmployeeID }) => {
    ...
    const handleFromChange = (val: string) => {
        ...
        if (toDate > maxDate) setToDate(maxDate);
    };
                ...
                <div className="row g-3 align-items-end">
                    {isAdmin && (
                        <div className="col-md-3">
                            <label className="form-label fw-semibold small text-muted">USER</label>
                            <select
                    ...
                    <div className="col-md-3">
                        <label className="form-label fw-semibold small text-muted">FROM DATE</label>
                        <input
                            type="date"
                    ...
                    <div className="col-md-3">
                        <label className="form-label fw-semibold small text-muted">TO DATE</label>
                        <input
                            type="date"
                            className="form-control form-control-sm"
                            value={toDate}
                                ...
                                {filtered.length === 0 ? (
                                    <tr>
                                        ...
                                        >
                                            <i className="bi bi-inbox" style={{
                                                fontSize: "2rem", display: "block", marginBottom: 8
                                            }} />
                                    ...
                                    filtered.map((p, i) => (
                                        <tr key={p.paymentID ?? i}>
                                            ...
                                            <td style={{ padding: "12px 16px" }}>
                                                <span style={{
                                                    fontWeight: 700, color: "#1B4332", fontSize: "0.95rem"
                                                }}>
                                                    Rs. {p.totalAmount}
                                                </span>
                                            </td>
